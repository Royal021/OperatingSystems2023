...
const char* decl = 
"\e\x17\fIN CONGRESS, July 4, 1776.\n\n"
...
"to the voice of justice and of consanguinity. \nWe \e\x1cmust\e\x17, therefore, acquiesce in the "
"\e\x71necessity\e\x17, which denounces our Separation, and hold \e\x1fthem\e\x17, as we hold the \e\x47rest\e\x17 of mankind, "
"Enemies in \e\x14War\e\x17, in \e\x1aPeace\e\x17\e\x19 Friends\e\x17.\n"
"We, therefore, the \e\xe6Representatives\e\x17 of the \e\xc0united\e\x17 \e\xf0States\e\x17 of \e\x90"
"America\e\x17, in General Congress, "
...
void sweet(){
    ...
    int fg=7,bg=2;
    for(i=0;phrase[i];++i){
        kprintf("\e%c%c", (bg<<4)|fg, phrase[i]); 
        if( phrase[i] == ' '){
            mode = 1-mode;
            fg=7;
            bg=1;
